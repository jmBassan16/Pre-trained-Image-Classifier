...
def get_input_args():
    ...
    parser.add_argument('--arch' , type = 'str' , default = '/vgg' , help = 'selection of CNN Model Architecture with default as vgg')
    parser.add_argument('--dogfile' , type = 'str' , default = '/dognames.txt' , help = 'text file with dognames')
    
    in_args = parser.parse_args()
    print('Argument 1 = ', in.in_args.dir)
    print('Argument 2 = ', in.in_args.arch)
    print('Argument 3 = ', in.in_args.dogfile)
